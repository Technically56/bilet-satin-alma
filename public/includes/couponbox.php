...
function renderCouponBox($boxtitle, array $coupons, string $company_name): string
{
    ...
    <div class="mt-5">
        ...
        <div class="card">
            <div class="card-body">
                <input type="hidden" value="<?php echo htmlspecialchars($_SESSION['csrf_token']); ?>" id="csrf_token"
                    name="csrf_token">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php foreach ($coupons as $coupon):
                                ...
                                <div class="modal fade" id="updateCouponModal_<?php echo htmlspecialchars($couponId); ?>"
                                    tabindex="-1">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <input type="hidden" value="<?php echo htmlspecialchars($couponId); ?>"
                                                    name="couponId" id="coupon_<?php echo htmlspecialchars($couponId); ?>">
                                                <div id="updateResultDiv_<?php echo htmlspecialchars($couponId); ?>"></div>
                                                <form>
                                                    <input type="hidden"
                                                        id="operationUpdate_<?php echo htmlspecialchars($couponId); ?>"
                                                        value="update" name="operation">
                                                    <div class="mb-3">
                                                        <label for="updateCouponCode_<?php echo htmlspecialchars($couponId); ?>"
                                                            class="form-label fw-bold">Kupon Kodu</label>
                                                        <input type="text" class="form-control"
                                                            id="updateCouponCode_<?php echo htmlspecialchars($couponId); ?>"
                                                            name="code" value="<?php echo htmlspecialchars($coupon['code']); ?>"
                                                            required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label
                                                            for="updateDiscountValue_<?php echo htmlspecialchars($couponId); ?>"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control" name="usage"
                                                            ...
                                                            value="<?php echo htmlspecialchars($coupon['usage_limit']); ?>"
                                                            step="1" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" class="form-control" name="date"
                                                            ...
                                                            value="<?php echo htmlspecialchars($formattedExpiry->format("Y-m-d")); ?>"
                                                            required>
                                                    </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="time" class="form-control" name="time"
                                                            ...
                                                            value="<?php echo htmlspecialchars($formattedExpiry->format("H:i")); ?>"
                                                            required>
                                                    </div>
                                                </form>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">İptal
                                                    Et</button>
                                                <button type="button" class="btn btn-primary" hx-post="/admin/api/couponapi.php"
                                                    hx-trigger="click" hx-swap="innerHTML"
                                                    hx-target="#updateResultDiv_<?php echo htmlspecialchars($couponId); ?>"
                                                    hx-include="
                            ...
                            ">Değişiklikleri Kaydet</button>
                                ...
                                <div class="modal fade" id="removeCouponModal_<?php echo htmlspecialchars($couponId); ?>"
                                    tabindex="-1">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p class="text-muted mb-0">
                                                    <strong>Kod:</strong><?php echo htmlspecialchars(" " . $coupon['code']); ?>
                                                </p>
                                                <div class="alert alert-warning mt-3" role="alert">
                                                    <strong>Uyarı:</strong> Bu işlem geri alınamaz.
                                                </div>
                                                <input type="hidden"
                                                    id="removeOperation_<?php echo htmlspecialchars($couponId); ?>"
                                                    name="operation" value="remove">
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Geri
                                                    Dön</button>
                                                <button type="button" class="btn btn-danger" hx-post="/admin/api/couponapi.php"
                                ...
                                <div class="modal-body">
                                    ...
                                    <form>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="discountValue" step="1"
